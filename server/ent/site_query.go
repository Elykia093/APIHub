...
type SiteQuery struct {
	...
	withCheckinRuns          *CheckinRunQuery
	withAnnouncementSyncRuns *AnnouncementSyncRunQuery
...
// QueryCheckinRuns chains the current query on the "checkin_runs" edge.
func (_q *SiteQuery) QueryCheckinRuns() *CheckinRunQuery {
	query := (&CheckinRunClient{config: _q.config}).Query()
...
// QueryAnnouncementSyncRuns chains the current query on the "announcement_sync_runs" edge.
func (_q *SiteQuery) QueryAnnouncementSyncRuns() *AnnouncementSyncRunQuery {
	query := (&AnnouncementSyncRunClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (_q *SiteQuery) QueryAnnouncements() *AnnouncementQuery {
...
func (_q *SiteQuery) Clone() *SiteQuery {
	...
	return &SiteQuery{
		...
		withCheckinRuns:          _q.withCheckinRuns.Clone(),
		withAnnouncementSyncRuns: _q.withAnnouncementSyncRuns.Clone(),
...
// WithCheckinRuns tells the query-builder to eager-load the nodes that are connected to
// the "checkin_runs" edge. The optional arguments are used to configure the query builder of the edge.
func (_q *SiteQuery) WithCheckinRuns(opts ...func(*CheckinRunQuery)) *SiteQuery {
	query := (&CheckinRunClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withCheckinRuns = query
	return _q
}

// WithAnnouncementSyncRuns tells the query-builder to eager-load the nodes that are connected to
// the "announcement_sync_runs" edge. The optional arguments are used to configure the query builder of the edge.
func (_q *SiteQuery) WithAnnouncementSyncRuns(opts ...func(*AnnouncementSyncRunQuery)) *SiteQuery {
	query := (&AnnouncementSyncRunClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withAnnouncementSyncRuns = query
	return _q
}
...
func (_q *SiteQuery) WithAnnouncements(opts ...func(*AnnouncementQuery)) *SiteQuery {
	query := (&AnnouncementClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *SiteQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Site, error) {
	var (
		...
		_spec       = _q.querySpec()
		loadedTypes = [3]bool{
			_q.withCheckinRuns != nil,
			_q.withAnnouncementSyncRuns != nil,
	...
	if query := _q.withCheckinRuns; query != nil {
		if err := _q.loadCheckinRuns(ctx, query, nodes,
			func(n *Site) { n.Edges.CheckinRuns = []*CheckinRun{} },
			func(n *Site, e *CheckinRun) { n.Edges.CheckinRuns = append(n.Edges.CheckinRuns, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withAnnouncementSyncRuns; query != nil {
		if err := _q.loadAnnouncementSyncRuns(ctx, query, nodes,
			func(n *Site) { n.Edges.AnnouncementSyncRuns = []*AnnouncementSyncRun{} },
			func(n *Site, e *AnnouncementSyncRun) {
				n.Edges.AnnouncementSyncRuns = append(n.Edges.AnnouncementSyncRuns, e)
			}); err != nil {
			return nil, err
		}
	}
	if query := _q.withAnnouncements; query != nil {
		if err := _q.loadAnnouncements(ctx, query, nodes,
			func(n *Site) { n.Edges.Announcements = []*Announcement{} },
			func(n *Site, e *Announcement) { n.Edges.Announcements = append(n.Edges.Announcements, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *SiteQuery) loadCheckinRuns(ctx context.Context, query *CheckinRunQuery, nodes []*Site, init func(*Site), assign func(*Site, *CheckinRun)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(checkinrun.FieldSiteID)
	}
	query.Where(predicate.CheckinRun(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(site.CheckinRunsColumn), fks...))
	}))
...
func (_q *SiteQuery) loadAnnouncementSyncRuns(ctx context.Context, query *AnnouncementSyncRunQuery, nodes []*Site, init func(*Site), assign func(*Site, *AnnouncementSyncRun)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[string]*Site)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(announcementsyncrun.FieldSiteID)
	}
	query.Where(predicate.AnnouncementSyncRun(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(site.AnnouncementSyncRunsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *SiteQuery) loadAnnouncements(ctx context.Context, query *AnnouncementQuery, nodes []*Site, init func(*Site), assign func(*Site, *Announcement)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[string]*Site)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(announcement.FieldSiteID)
	}
	query.Where(predicate.Announcement(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(site.AnnouncementsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
